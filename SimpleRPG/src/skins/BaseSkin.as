package skins
{
	...
	public class BaseSkin extends Skin
	{
		 ...
		 * 文本投影滤镜
		 */		
		public static var textOverFilter:Array = [new DropShadowFilter(1,270,0,0.3,1,1)];
		/**
		 * 边框线条颜色
		 */		
		public static var borderColors:Array = [0xD4D4D4,0x518CC6,0x686868];
		/**
		 * 底线颜色
		 */		
		public static var bottomLineColors:Array = [0xBCBCBC,0x2A65A0,0x656565];
		/**
		 * 边框圆角
		 */		
		public static var cornerRadius:Number = 5;
		/**
		 * 填充颜色 
		 */		
		public static var fillColors:Array = [0xFAFAFA,0xEAEAEA,0x589ADB,0x3173B4,0x777777,0x9B9B9B];
		/**
		 * 主题颜色，应用到文本或者图标上
		 */		
		public static var themeColors:Array = [0x333333,0xFFFFFF];
		/**
		 * 绘制当前的视图状态
		 */		
		public function drawCurrentState(x:Number,y:Number,w:Number,h:Number,borderColor:uint,
											bottomLineColor:uint,fillColors:Object,cornerRadius:Object=null,g:Graphics=null):void
		{
			...
			drawRoundRect(
				x+3, y+3, w - 6, h - 6, r-3,
				fillColors, 1,
				verticalGradientMatrix(x, y, w - 8, h - 8),GradientType.LINEAR,null,null,g); 
